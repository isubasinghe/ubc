...
(define-sort SchedState () (_ BitVec 1))
(define-sort SchedState<> () (_ BitVec 1))
(define-fun <BoundTCB> () SchedState<> (_ bv0 1))
(define-fun <BoundNotification> () SchedState<> (_ bv1 1))
(assert (distinct <BoundTCB> <BoundNotification>))
(define-fun SchedState.<> ((v SchedState)) SchedState<> ((_ extract 0 0) v))
(define-fun BoundTCB () SchedState <BoundTCB>)
(define-fun BoundNotification () SchedState <BoundNotification>)
...
;   }
(define-sort PlatformContext () (_ BitVec 408))
(define-fun LC ((a PD) (b NextRecv) (c Ch_set) (d Ch_set) (e Maybe_Prod_Ch_MsgInfo) (f Maybe_MsgInfo) (g Maybe_MsgInfo) (h SchedState)) PlatformContext (concat a (concat b (concat c (concat d (concat e (concat f (concat g h))))))))
(define-fun lc_running_pd ((c PlatformContext)) PD ((_ extract 407 402) c))
(define-fun lc_running_pd= ((c PlatformContext) (v PD)) PlatformContext (concat v ((_ extract 401 0) c)))
(define-fun lc_receive_oracle ((c PlatformContext)) NextRecv ((_ extract 401 330) c))
(define-fun lc_receive_oracle= ((c PlatformContext) (v NextRecv)) PlatformContext (concat ((_ extract 407 402) c) (concat v ((_ extract 329 0) c))))
(define-fun lc_unhandled_notified ((c PlatformContext)) Ch_set ((_ extract 329 266) c))
(define-fun lc_unhandled_notified= ((c PlatformContext) (v Ch_set)) PlatformContext (concat ((_ extract 407 330) c) (concat v ((_ extract 265 0) c))))
(define-fun lc_last_handled_notified ((c PlatformContext)) Ch_set ((_ extract 265 202) c))
(define-fun lc_last_handled_notified= ((c PlatformContext) (v Ch_set)) PlatformContext (concat ((_ extract 407 266) c) (concat v ((_ extract 201 0) c))))
(define-fun lc_unhandled_ppcall ((c PlatformContext)) Maybe_Prod_Ch_MsgInfo ((_ extract 201 131) c))
(define-fun lc_unhandled_ppcall= ((c PlatformContext) (v Maybe_Prod_Ch_MsgInfo)) PlatformContext (concat ((_ extract 407 202) c) (concat v ((_ extract 130 0) c))))
(define-fun lc_unhandled_reply ((c PlatformContext)) Maybe_MsgInfo ((_ extract 130 66) c))
(define-fun lc_unhandled_reply= ((c PlatformContext) (v Maybe_MsgInfo)) PlatformContext (concat ((_ extract 407 131) c) (concat v ((_ extract 65 0) c))))
(define-fun lc_last_handled_reply ((c PlatformContext)) Maybe_MsgInfo ((_ extract 65 1) c))
(define-fun lc_last_handled_reply= ((c PlatformContext) (v Maybe_MsgInfo)) PlatformContext (concat ((_ extract 407 66) c) (concat v ((_ extract 0 0) c))))
(define-fun lc_schedstate ((c PlatformContext)) SchedState ((_ extract 0 0) c))
(define-fun lc_schedstate= ((c PlatformContext) (v SchedState)) PlatformContext (concat ((_ extract 407 1) c) v))
