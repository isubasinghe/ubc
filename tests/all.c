...
// (define-fun loop_invariant@5 ((a___int@v (_ BitVec 32)) (i___int@v (_ BitVec
// 32)) (loop@4@count (_ BitVec 64))) Bool (and (and (bvsle (_ bv0 32)
// i___int@v)
...
int undefined_var_with_loops___fail_missing_invariant() {
  ...
  // if it is indeed undefined, i won't be able to say anything about it (can't
  // prove loop invariants) otherwise, if the invariant holds, you're fine.
  int a;
  for (int i = 0; i < 10; i++)
...
// (define-fun and6 ((a1 Bool) (a2 Bool) (a3 Bool) (a4 Bool) (a5 Bool) (a6
// Bool)) Bool
//     (and a1 (and a2 (and a3 (and a4 (and a5 a6)))))
// )
// (define-fun even ((x (_ BitVec 32))) Bool (= (bvsmod x (_ bv2 32)) (_ bv0
// 32))) (define-fun odd ((x (_ BitVec 32))) Bool (distinct (bvsmod x (_ bv2
// 32)) (_ bv0 32))) (define-fun loop_invariant@9 ((a___int@v (_ BitVec 32))
// (b___int@v (_ BitVec 32)) (c___int@v (_ BitVec 32)) (j___int@v (_ BitVec 32))
// (loop@8@count (_ BitVec 64))) Bool
//     (and6 (bvsle (_ bv0 32) j___int@v)
//           (bvsle j___int@v (_ bv10 32))
//           (=> (and (bvsgt j___int@v (_ bv0 32)) (= c___int@v (_ bv1 32))) (=
//           b___int@v (_ bv1 32)))
//           (=> (and (bvsgt j___int@v (_ bv0 32)) (= c___int@v (_ bv2 32))) (=
//           a___int@v (_ bv2 32)))
//           (=> (and (bvsgt j___int@v (_ bv0 32)) (odd i___unsigned@v~1)) (=
//           c___int@v (_ bv1 32)))
//           (=> (and (bvsgt j___int@v (_ bv0 32)) (even i___unsigned@v~1)) (=
//           c___int@v (_ bv2 32)))
// ))
...
// (define-fun and5 ((a1 Bool) (a2 Bool) (a3 Bool) (a4 Bool) (a5 Bool)) Bool
// (and a1 (and a2 (and a3 (and a4 a5))))) (define-fun loop_invariant@5
// ((a___int@v (_ BitVec 32)) (a___int@v@assigned Bool) (b___int@v (_ BitVec
// 32)) (b___int@v@assigned Bool) (i___int@v (_ BitVec 32)) (i___int@v@assigned
// Bool) (loop@4@count (_ BitVec 64)) (loop@4@count@assigned Bool)) Bool (and
// loop@4@count@assigned
//     (and5 i___int@v@assigned
//           (bvsle (_ bv0 32) i___int@v)
//           (bvsle i___int@v (_ bv10 32))
//           (=> (bvsle (_ bv3 32) i___int@v) (and a___int@v@assigned (=
//           a___int@v (_ bv1 32))))
...
int loop_conditional_extra3__fails_because_no_inv() {
  ...
  //      i >= 6 ==> b_defined
  {
    ...
    if (i == 5) {
      b = a + 1; // b_defined = a_defined
      b = b + c; // b_defined = b_defined AND c_defined (ie. we need to apply
                 // dsa on x_defined variables)
    }
  }
  // adds proof_obligation: a_defined
  return b;
...
int ret_variable___fail_overflow(int ret) { return ret + 1; }
...
int less_than(int n, int m) { return n < m; }
...
int caller(int b) { return callee(b) * 2; }

int caller2(int b) { return callee(callee(b)) * 2; }
...
int does_not_change_ghost_using_prelude() { return 0; }
