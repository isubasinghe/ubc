...
def gen_nonrec_data_type(
    data_type_name: str,
    constructors: dict[str, Sequence[ExternType]],
    assign_values_to_constructors: bool = False,
) -> ExternType:
